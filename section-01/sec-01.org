...
#+LATEX: \renewcommand{\Cp}{{\bf C}^{\prime}}
#+LATEX: \renewcommand{\b}{{\bf b}}
#+LATEX: \renewcommand{\Xp}{{\bf X}^\prime}
#+LATEX: \renewcommand{\Xs}{{\bf X}^{*}}
#+LATEX: \renewcommand{\Xsp}{{\bf X}^{*\prime}}
#+LATEX: \renewcommand{\eps}{{\bf \epsilon}}
#+LATEX: \renewcommand{\epsp}{{\bf \epsilon}^\prime}
#+LATEX: \renewcommand{\Om}{{\bf \Omega}}
#+LATEX: \renewcommand{\Ominv}{{\bf \Omega}^{-1}}
...
#+LATEX: \renewcommand{\N}{\mathcal{N}}
#+LATEX: \renewcommand{\bh}{\hat{\beta}}
#+LATEX: \renewcommand{\gh}{\hat{\gamma}}
#+LATEX: \renewcommand{\yt}{\tilde{{\bf y}}}
#+LATEX: \renewcommand{\Xt}{\tilde{{\bf X}}}
#+LATEX: \renewcommand{\x}{{\bf x}}
#+LATEX: \renewcommand{\epst}{\tilde{{\bf \epsilon}}}
#+LATEX: \renewcommand{\rxz}{\rho_{xz}}
